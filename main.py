...
TEXTS = {
    "💻 [PC] NerestPC Free 0.32.3": "ℹ️ Краткий туториал : \n1-Распакуй папку NerestPC Free из архива на рабочий стол \n2-Запусти exe \n3-Нажми 1 и enter \nЕсли блюстакс закрылся повторяем процесс заново \n(Иногда может понадобиться повторить процесс до 10 раз) \n\n[Канал](https://t.me/sukunasoft)",
    "💻 [PC] Nerest External Crack 0.32.3": "ℹ️ Туториал находиться в архиве с читом\n\n[Канал](https://t.me/sukunasoft)",
